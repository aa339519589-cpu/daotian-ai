;(function(){
  'use strict';
  window.__DAOTIAN_STREAM_SMOOTH_HOTFIX__='v1.2.2-disabled-native-delta-sidebar-compact';
...
.sidebar{background:rgba(31,31,30,.9)!important;backdrop-filter:blur(22px) saturate(1.03)!important;-webkit-backdrop-filter:blur(22px) saturate(1.03)!important;border-right:1px solid rgba(238,238,238,.08)!important}.sidebar::before{background:linear-gradient(180deg,rgba(255,255,255,.018),rgba(255,255,255,.006))!important}.sidebar-top{height:58px!important;padding:0 14px!important;gap:10px!important}.sidebar-label{font-family:ui-serif,Georgia,Cambria,"Times New Roman",Times,"Songti SC","STSong",serif!important;color:#eee!important;font-size:17px!important;font-weight:430!important;letter-spacing:.01em!important;line-height:1!important;flex:1!important}.dt-side-layout{width:30px!important;height:30px!important;border:0!important;background:transparent!important;color:rgba(238,238,238,.62)!important;display:grid!important;place-items:center!important;padding:0!important;margin-left:auto!important}.dt-side-new{height:42px;margin:8px 12px 18px;display:flex;align-items:center;gap:12px;color:#eee;background:transparent!important;border:0!important;padding:0!important;font:inherit;text-align:left}.dt-side-new .plus{width:34px;height:34px;border-radius:999px;background:rgba(255,255,255,.075);display:grid;place-items:center;font-size:24px;font-weight:260;line-height:1}.dt-side-new .txt{font-size:15px;font-weight:430;color:#eee}.dt-side-recent{margin:0 14px 8px;color:rgba(238,238,238,.50);font-size:13px;font-weight:400}.chat-list{padding:0 8px 58px!important;gap:0!important}.chat-item{width:calc(100% - 8px)!important;min-height:46px!important;margin:0 4px!important;padding:0 8px!important;border-radius:10px!important;gap:8px!important;color:rgba(238,238,238,.86)!important}.chat-item.active{background:rgba(255,255,255,.05)!important;color:#eee!important}.chat-item.dt-hide-empty{display:none!important}.chat-dot{width:5px!important;height:5px!important;background:rgba(238,238,238,.24)!important}.chat-item.active .chat-dot,.chat-item.pinned .chat-dot{background:#c96442!important}.chat-title{font-size:14px!important;font-weight:500!important;color:inherit!important;line-height:1.35!important}.chat-time{display:none!important}.delete-chat,.chat-more{display:grid!important;place-items:center!important;width:26px!important;height:26px!important;border-radius:8px!important;color:rgba(238,238,238,.56)!important;background:transparent!important;border:0!important;font-size:0!important;opacity:1!important;margin-left:auto!important;flex:0 0 auto!important}.chat-more::before{content:"•••";font-size:14px!important;letter-spacing:1.2px!important;line-height:1!important}.sidebar-bottom{border-top:1px solid rgba(238,238,238,.06)!important;padding:6px 8px 10px!important;display:flex!important;flex-direction:column!important;gap:2px!important;background:transparent!important}.side-bottom-btn{height:32px!important;border-radius:10px!important;padding:0 10px!important;text-align:center!important;color:rgba(238,238,238,.56)!important;font-size:14px!important;font-weight:520!important;background:transparent!important;border:0!important}.side-bottom-btn:hover{background:rgba(238,238,238,.05)!important;color:#eee!important}.dt-chat-menu{position:fixed;z-index:9000;min-width:154px;padding:8px;border-radius:14px;background:rgba(48,48,47,.96);border:1px solid rgba(238,238,238,.13);box-shadow:0 14px 42px rgba(0,0,0,.36);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px)}.dt-chat-menu button{width:100%;height:40px;border:0;background:transparent;color:#eee;border-radius:10px;display:flex;align-items:center;gap:10px;padding:0 10px;font:inherit;font-size:15px;text-align:left}.dt-chat-menu button:hover{background:rgba(255,255,255,.06)}.dt-chat-menu .delete{color:#e1737b!important}.dt-chat-menu .sep{height:1px;background:rgba(238,238,238,.10);margin:4px 2px}@media(max-width:900px){.sidebar{width:min(78vw,640px)!important;min-width:min(78vw,640px)!important}.sidebar.closed{width:0!important;min-width:0!important}}';
  ...
  function patch(){
    ...
    try{
      ...
      var top=side.querySelector('.sidebar-top');
      if(top&&!top.querySelector('.dt-side-layout')){
        var lay=document.createElement('button');
        lay.type='button';lay.className='dt-side-layout';
        lay.innerHTML='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="4" y="5" width="16" height="14" rx="2"/><line x1="12" y1="5" x2="12" y2="19"/></svg>';
        top.appendChild(lay);
      }
  ...
  function openMenu(btn,id){
    ...
    menu.innerHTML='<button type="button" data-side-action="star">☆ '+(p?'Unstar':'Star')+'</button><button type="button" data-side-action="rename">✎ Rename</button><div class="sep"></div><button type="button" class="delete" data-del="'+esc(id)+'">⌫ Delete</button>';
  ...
  function bind(){
    ...
    document.addEventListener('click',function(e){
      ...
      if(more){e.preventDefault();e.stopPropagation();openMenu(more,more.getAttribute('data-chat-menu'));return;}
      ...
      if(menu&&menu.contains(e.target)){
        ...
        if(act){
          ...
          var m=meta();
          if(act.getAttribute('data-side-action')==='star'){m.pinned[id]=!m.pinned[id];if(!m.pinned[id])delete m.pinned[id];saveMeta(m);closeMenu();patch();return;}
