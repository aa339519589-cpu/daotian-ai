(function(){
  ...
  try{
    ...
    app.innerHTML = `
      <div class="app-shell" data-theme="${theme}">
        <aside class="sidebar" id="sidebar">
          <div class="sidebar-top"><button class="icon-btn" id="closeSide" title="收起">☰</button><svg class="brand-logo" viewBox="0 0 100 100"><circle cx="50" cy="50" r="42" fill="none" stroke="currentColor" stroke-width="2.5"/><line x1="50" y1="68" x2="50" y2="24" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><path d="M50 24 C38 16 26 20 26 32 C26 40 40 35 50 35" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round"/><path d="M50 24 C62 16 74 20 74 32 C74 40 60 35 50 35" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round"/><path d="M18 62 Q34 54 50 60" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M82 62 Q66 54 50 60" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M22 70 Q36 64 50 68" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M78 70 Q64 64 50 68" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg><div class="brand">稻田 Ai</div></div>
    ...
    function renderMessages(){
      ...
      if(msgs.length===0){
        box.innerHTML = `<div class="empty"><div class="empty-center"><svg class="empty-logo" viewBox="0 0 200 200"><circle cx="100" cy="88" r="60" fill="none" stroke="currentColor" stroke-width="3"/><line x1="100" y1="120" x2="100" y2="42" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><path d="M100 42 C78 28 58 36 58 56 C58 68 82 62 100 62" fill="none" stroke="currentColor" stroke-width="2.8" stroke-linecap="round"/><path d="M100 42 C122 28 142 36 142 56 C142 68 118 62 100 62" fill="none" stroke="currentColor" stroke-width="2.8" stroke-linecap="round"/><path d="M46 102 Q72 88 100 98" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M154 102 Q128 88 100 98" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M52 116 Q76 102 100 110" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M148 116 Q124 102 100 110" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg><div class="empty-prompt">${escapeHTML(pickEmptyPrompt())}</div></div></div>`;
        return;
      }
