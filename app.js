(function(){
  ...
  try{
    ...
    app.innerHTML = `
      <div class="app-shell" data-theme="${theme}">
        <aside class="sidebar" id="sidebar">
          <div class="sidebar-top"><button class="icon-btn" id="closeSide" title="收起">☰</button><svg class="brand-logo" viewBox="0 0 100 100"><circle cx="50" cy="48" r="29" fill="none" stroke="currentColor" stroke-width="2.5"/><line x1="50" y1="66" x2="50" y2="33" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><path d="M50 33 C44 31 37 33 35 39" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M50 33 C56 31 63 33 65 39" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M25 58 Q38 50 50 54" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M75 58 Q62 50 50 54" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M28 65 Q39 57 50 61" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><path d="M72 65 Q61 57 50 61" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg><div class="brand">稻田 Ai</div></div>
    ...
    function renderMessages(){
      ...
      if(msgs.length===0){
        box.innerHTML = `<div class="empty"><div class="empty-center"><svg class="empty-logo" viewBox="0 0 200 200"><circle cx="100" cy="95" r="58" fill="none" stroke="currentColor" stroke-width="2.8"/><line x1="100" y1="130" x2="100" y2="65" stroke="currentColor" stroke-width="2.8" stroke-linecap="round"/><path d="M100 65 C88 60 74 64 70 76" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><path d="M100 65 C112 60 126 64 130 76" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/><path d="M50 115 Q75 100 100 108" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M150 115 Q125 100 100 108" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M54 128 Q77 114 100 121" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M146 128 Q123 114 100 121" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg><div class="empty-prompt">${escapeHTML(pickEmptyPrompt())}</div></div></div>`;
        return;
      }
