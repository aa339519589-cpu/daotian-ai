(function(){
  ...
  try{
    ...
    app.innerHTML = `
      <div class="app-shell" data-theme="${theme}">
        <aside class="sidebar" id="sidebar">
          <div class="sidebar-top"><button class="icon-btn" id="closeSide" title="收起">☰</button><img src="./logo.png" class="brand-logo" alt=""><div class="brand">稻田 Ai</div></div>
    ...
    function renderMessages(){
      ...
      if(msgs.length===0){
        box.innerHTML = `<div class="empty"><div class="empty-center"><img src="./logo.png" class="empty-logo" alt="稻田 Ai"><div class="empty-prompt">${escapeHTML(pickEmptyPrompt())}</div></div></div>`;
        return;
      }
